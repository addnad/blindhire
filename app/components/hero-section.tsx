      ...
      <section className="min-h-screen flex items-center">
        <div className="mx-auto max-w-6xl px-6 pt-32 pb-24 md:pt-40 md:pb-32">
          <div className="max-w-3xl">
            ...
            <TextEffect preset="fade-in-blur" speedSegment={0.3} as="h1" className="mt-6 text-6xl font-semibold md:text-7xl xl:text-8xl">
              Hire without
            </TextEffect>
            <TextEffect preset="fade-in-blur" speedSegment={0.3} as="h1" className="text-6xl font-semibold md:text-7xl xl:text-8xl text-muted-foreground">
              bias or exposure.
            </TextEffect>
            <TextEffect per="line" preset="fade-in-blur" speedSegment={0.3} delay={0.5} as="p" className="mt-8 max-w-xl text-pretty text-lg text-muted-foreground">
            ...
            <AnimatedGroup
              ...
              <Button asChild size="lg" className="px-6 text-base">
                <Link href="/employer"><span>Post a Role</span></Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="px-6 text-base">
                <Link href="/candidate"><span>Apply as Candidate</span></Link>
              </Button>
            </AnimatedGroup>
          </div>
        </div>
