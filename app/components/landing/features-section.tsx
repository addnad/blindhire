...
const features = [
  {
    number: "01",
    title: "Encrypted Requirements",
    description: "Employers set minimum experience and skill thresholds that are encrypted client-side before touching the chain. Candidates never see the bar they need to clear.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Zero-Knowledge Matching",
    description: "The smart contract runs comparisons entirely in encrypted space using FHE operations. No raw values are ever decrypted during computation — not even by the contract.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Blind Applications",
    description: "Candidates encrypt their credentials locally. Their wallet address is baked into the ciphertext — only they can decrypt their own result. The employer sees nothing.",
    visual: "collab",
  },
  {
    number: "04",
    title: "On-chain Verifiable",
    description: "Every match is computed and stored on Sepolia. Results are cryptographically verifiable. No middleman, no black box — just math on encrypted data.",
    visual: "security",
  },
];
  ...
  return (
    <svg viewBox="0 0 200 160" className="w-full h-full">
      <g>
        ...
        <text x="55" y="85" textAnchor="middle" fontSize="14" fontFamily="monospace" fill="currentColor">EMP</text>
      ...
      <g>
        ...
        <text x="145" y="85" textAnchor="middle" fontSize="14" fontFamily="monospace" fill="currentColor">CAN</text>
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="mb-16 lg:mb-24">
          ...
          <h2 className={`text-4xl lg:text-6xl font-display tracking-tight transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
            Full privacy.<br />
            <span className="text-muted-foreground">Both sides of the table.</span>
          </h2>
        </div>
        <div>
